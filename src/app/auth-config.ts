 ...
 */
 ...
 export const b2cPolicies = {
     names: {
         signUpSignIn: 'B2C_1_dp-signupsignin1',
         resetPassword: 'B2C_1_dp-resetPassword',
         editProfile: 'B2C_1_profileediting1',
     },
     authorities: {
         signUpSignIn: {
             authority: 'https://qeddpb2c.b2clogin.com/qeddpb2c.onmicrosoft.com/B2C_1_dp-signupsignin1',            
         },
         resetPassword: {
             authority: 'https://qeddpb2c.b2clogin.com/qeddpb2c.onmicrosoft.com/B2C_1_dp-resetPassword',
         },
         editProfile: {
             authority: 'https://qeddpb2c.b2clogin.com/qeddpb2c.onmicrosoft.com/B2C_1_profileediting1',
         },
     },
     authorityDomain: 'qeddpb2c.b2clogin.com',
 };
 ...
 export const msalConfig: Configuration = {
     auth: {
         clientId: 'e5ca41dd-d2a1-4005-9a60-0535422974e5', // This is the ONLY mandatory field that you need to supply.
